                    ...
                    <div class="row address">
                        <div class="col-md-12">
                            <div class="form-group{{ $errors->has('address') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <input readonly="readonly"  required id="address" type="text" class="form-control" name="address"
                                           value="{{ old('address') }}">
                            ...
                            <div class="form-group{{ $errors->has('wifi') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <label class="radio-inline"><input type="radio" name="wifi" value="yes"
                                                                       checked="checked">Yes</label>
                                    <label class="radio-inline"><input type="radio" name="wifi" value="No">No</label>
                                    @if ($errors->has('wifi'))
                                        <span class="help-block">
                        ...
                        <div class="col-md-12">
                            <div class="form-group{{ $errors->has('additionalDescription') ? ' has-error' : '' }}">
                                ...
                                <textarea rows="3" id="additionalDescription" type="text" class="form-control"
                                          name="additionalDescription" value="{{ old('additionalDescription') }}">
                                </textarea>
...
<script type="text/javascript" src="//maps.googleapis.com/maps/api/js?key=AIzaSyD8cMWUk-plcymD9_xSx3yPupUoPyyLl-4"></script>
{{--<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBu-916DdpKAjTmJNIgngS6HL_kDIKU0aU&callback=myMap"></script>--}}
